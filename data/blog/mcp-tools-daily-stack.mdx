...
draft: false
summary: 'Four tools I use every day with Claude Code — Serena, Playwright MCP, Superpowers, and Context7 — what each does and why it earns its spot.'
layout: PostSimple
authors: ['default']
---
...
These four tools are daily drivers, not experiments. Each one addresses a real gap:
