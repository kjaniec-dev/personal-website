...
You can find the full source code at [github.com/kjaniec-dev/planning-poker](https://github.com/kjaniec-dev/planning-poker). The application is a real-time collaborative estimation tool built with modern web technologies and designed for flexibility in deployment.
...
/server-node       # Node.js WebSocket server
...
- Persistent room history and estimation analytics
- Integration with project management tools like Jira or Linear
- Support for custom card decks (Fibonacci, T-shirt sizes, etc.)
- Voice/video integration for better remote collaboration

## Try It Yourself

The project is open source and available at [github.com/kjaniec-dev/planning-poker](https://github.com/kjaniec-dev/planning-poker). Whether you want to use it for your team or learn from the implementation, feel free to clone it and give it a try!
