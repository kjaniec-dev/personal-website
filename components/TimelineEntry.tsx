...
const TimelineEntry = ({
  ...
  <div className="group flex md:contents">
    ...
    {/* Content */}
    <div className="hover:border-primary-200 dark:hover:border-primary-800 col-start-3 col-end-12 mr-auto mb-8 ml-4 w-full rounded-xl border border-gray-200/60 bg-white/60 p-5 shadow-sm backdrop-blur-sm transition-all hover:shadow-md md:ml-8 dark:border-gray-700/60 dark:bg-gray-900/60">
